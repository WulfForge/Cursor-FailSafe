...
export class DashboardCommands {
     ...
     */
    public async exportDashboardReport(): Promise<void> {
        try {
     ...
     */
    public async exportSprintReport(): Promise<void> {
        try {
     ...
     */
    public async exportCursorRulesReport(): Promise<void> {
        try {
     ...
     */
    public async exportProjectHealthReport(): Promise<void> {
        try {
     ...
     */
    public async customizeDashboardTheme(): Promise<void> {
        try {
            const themes = [
     ...
     */
    public async customizeDashboardLayout(): Promise<void> {
        try {
            const layouts = [
                { name: 'Default', value: 'default' },
     ...
     */
    public async configureDashboardWidgets(): Promise<void> {
        try {
            const widgets = [
     ...
     */
    public async exportDashboardAsPDF(): Promise<void> {
        try {
     ...
     */
    public async shareDashboardSnapshot(): Promise<void> {
        try {
    ...
    private async generateDashboardReport(): Promise<any> {
        const currentSprint = await this.sprintPlanner.getCurrentSprint();
        const rules = this.cursorrulesEngine.getAllRules();
        const stats = this.cursorrulesEngine.getStats();
    ...
    private async generateProjectHealthData(): Promise<any> {
        const currentSprint = await this.sprintPlanner.getCurrentSprint();
    ...
    private async showCustomThemeEditor(): Promise<void> {
        const panel = vscode.window.createWebviewPanel(
            'customThemeEditor',
            'Custom Theme Editor',
            vscode.ViewColumn.One,
    ...
    private async createDashboardSnapshot(): Promise<any> {
        const reportData = await this.generateDashboardReport();
        return {
            ...reportData,
    ...
    private generateDashboardReportHTML(reportData: any): string {
        return `
            <!DOCTYPE html>
            <html>
            <head>
    ...
    private generateSprintReportHTML(sprintData: any, sprintMetrics: any): string {
        return `
            <!DOCTYPE html>
            <html>
            <head>
            ...
            <body>
                ...
                <div class="section">
                    ...
                    <p><strong>In Progress:</strong> ${sprintData.tasks.filter((t: any) => t.status === 'IN_PROGRESS').length}</p>
                    <p><strong>Blocked:</strong> ${sprintData.tasks.filter((t: any) => t.status === 'BLOCKED').length}</p>
                </div>
    ...
    private generateCursorRulesReportHTML(rules: any[], stats: any): string {
        return `
            <!DOCTYPE html>
            <html>
            <head>
    ...
    private generateProjectHealthReportHTML(healthData: any): string {
        return `
            <!DOCTYPE html>
            <html>
            <head>
    ...
    private generateWidgetConfigurationHTML(widgets: any[]): string {
        return `
            <!DOCTYPE html>
            <html>
            <head>
    ...
    private generateCustomThemeEditorHTML(): string {
        return `
            <!DOCTYPE html>
            <html>
            <head>
    ...
    private generateDashboardSnapshotHTML(snapshot: any): string {
        return `
            <!DOCTYPE html>
            <html>
            <head>
    ...
    private groupRulesByPurpose(rules: any[]): any[] {

...
${r.error}\n`;
    ...
    private async createCursorRule(ruleData: any): Promise<void> {
        const fs = require('fs');
...
This rule helps ensure ${ruleData.purpose || 'validation'} follows best practices and maintains quality standards.`;
    ...
    private async updateCursorRulesFile(ruleData: any): Promise<void> {
        const fs = require('fs');
        const path = require('path');
...
`;
    ...
    private mapResponse(response: string): string {
    ...
    private getResponseDescription(response: string): string {
    ...
    private getActionDescription(response: string): string {
    ...
    private getFallbackDescription(response: string): string {

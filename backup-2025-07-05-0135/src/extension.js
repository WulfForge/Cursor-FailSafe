...
class FailSafeExtension {
    ...
    async activate() {
        ...
        try {
            ...
            previewCommands_1.PreviewCommands.registerCommands(this.context);
            ...
            try {
                ...
                const commandsDisposable = vscode.window.registerTreeDataProvider('failsafe-commands', this.sidebarProvider);
    ...
    async validateExtensionEnvironment() {
        try {

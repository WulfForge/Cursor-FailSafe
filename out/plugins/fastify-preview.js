...
const fastifyPreview = async (fastify) => {
            ...
            try {
                ...
                await previewServer.register(async (instance) => {
                    instance.get('/preview/component/:id', async (request, reply) => {
                        ...
                        const preview = await fastify.preview.generateComponentPreview(id, options);
                    ...
                    instance.get('/preview/design', async (request, reply) => {
                        ...
                        const preview = await fastify.preview.generateDesignPreview(designPath, options);
                        return reply.send(preview);
                    });
